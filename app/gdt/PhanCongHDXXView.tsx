...
function ThemBieuMauModal({
  ...
  const JUDGE_INFO: Record<string, { chucVu: string; ngaySinh: string }> = {
    ...
    "Phạm Thị Bích Ngọc": { chucVu: "Công chức chính", ngaySinh: "18/11/1982" },
                ...
                {cases.map((c, idx) => (
                  ...
                  >
                    ...
                    <td style={{ ...TD_STYLE, fontSize: 11, padding: "8px" }}>
                      ...
                      <div><span style={{ color: MUTED }}>Công chức:</span> {c.ttv}</div>
        ...
        {open && (
          <>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: 12 }}>
              ...
              {col("Công chức/Thư ký", <select style={inSt}><option value="">– Tất cả –</option><option>Nguyễn Thu Hằng</option><option>Lý Văn An</option></select>)}
            </div>
