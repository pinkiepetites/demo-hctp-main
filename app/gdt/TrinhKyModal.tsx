          ...
          <div style={{ flex: 1, overflowY: "auto", display: "flex", justifyContent: "center", padding: "24px 16px" }}>
            ...
            >
              ...
              <div style={{ fontSize: 12, textAlign: "justify" }}>
                ...
                <div style={{ fontWeight: 700, marginBottom: 6 }}>3. Nhận định và đề xuất của Công chức</div>
                <p style={{ margin: "0 0 10px", textIndent: 24 }}>
                  Qua nghiên cứu toàn bộ hồ sơ vụ án, lời khai của các bên liên quan và kết luận giám định pháp y số 28/GĐ-PY, Công chức nhận thấy có tình tiết mới làm thay đổi cơ bản nội dung vụ án mà Tòa án cấp sơ thẩm và phúc thẩm chưa xem xét đầy đủ.
                </p>
                <p style={{ margin: "0 0 10px", textIndent: 24 }}>
...
export function TrinhKyModal({ onClose }: { onClose: () => void }) {
  ...
  const getSingleOptions = () => {
    ...
    if (capTrinh === "Nghiên cứu lại, xác minh, bổ sung") return ["Lý Thái Phúc – Công chức", "Nguyễn Minh Tú – Công chức"];
    return [];
  };
        ...
        <div style={{ flex: 1, background: "#666666", overflow: "auto", display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ flex: 1, display: "flex", justifyContent: "center", padding: 32, overflowY: "auto" }}>
            <div style={{ background: "#fff", width: "100%", maxWidth: 640, padding: "48px 64px", boxShadow: "0 4px 24px rgba(0,0,0,0.3)", fontFamily: "serif", lineHeight: 1.9, fontSize: 13 }}>
              ...
              <p style={{ textAlign: "justify", marginBottom: 16, fontSize: 12 }}>Căn cứ đơn đề nghị xem xét theo thủ tục giám đốc thẩm, tái thẩm và các tài liệu có trong hồ sơ vụ việc; Công chức báo cáo kết quả nghiên cứu hồ sơ như sau:</p>
              ...
              <p style={{ textAlign: "justify", fontSize: 12, marginBottom: 40 }}>Qua kiểm tra, hồ sơ có nội dung cần xin ý kiến lãnh đạo để thống nhất hướng xử lý. Công chức kính đề nghị lãnh đạo xem xét, cho ý kiến chỉ đạo làm căn cứ thực hiện các bước tiếp theo theo đúng quy định.</p>
