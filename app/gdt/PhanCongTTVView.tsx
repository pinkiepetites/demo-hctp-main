...
export function PhanCongTTVView() {
  ...
  // người có thẩm quyền phải chọn đích danh Công chức nghiên cứu, không bốc thăm.
  ...
  const handleExecutePhanCong = () => {
    if (selectedIds.length === 0) {
      alert("Vui lòng tích chọn ít nhất 1 vụ án để phân công Công chức nghiên cứu!");
      return;
    }
  ...
  const handleConfirmChiDinh = () => {
    ...
    alert(`Đã phân công chỉ định thành công cho Công chức nghiên cứu: ${assignTTV}!`);
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", overflowY: "auto", background: "#fafafa", fontFamily: F }}>
      ...
      <div style={{ padding: "10px 24px", fontSize: 12, color: MUTED, fontFamily: F, background: "#fff", borderBottom: `1px solid ${BORDER}` }}>
        <span>Trang chủ</span> &nbsp;/&nbsp; <span>Quản lý án GĐT/TT</span> &nbsp;/&nbsp; <span style={{ color: TEXT, fontWeight: 600 }}>Phân công Công chức nghiên cứu</span>
      </div>

      <div style={{ padding: "20px 24px", display: "flex", flexDirection: "column", gap: 16 }}>
        {/* Page Title */}
        <h1 style={{ fontSize: 18, fontWeight: 700, color: TEXT, margin: 0, fontFamily: F }}>
          Phân công Công chức nghiên cứu
        </h1>
          ...
          {filterExpanded && (
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "10px 16px" }}>
                ...
                <div>
                  <label style={labelStyle}>Công chức nghiên cứu</label>
                  <select
                    value={fTTV}
                    onChange={(e) => setFTTV(e.target.value)}
                    style={inputStyle}
                  >
                    <option value="">Chọn Công chức nghiên cứu</option>
                    {DANH_SACH_TTV.map((t) => (
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 1200 }}>
              <thead>
                <tr>
                  ...
                  <th style={{ ...TH_CUSTOM, width: "10%" }}>Ngày Công chức nghiên cứu nhận THS</th>
                  <th style={{ ...TH_CUSTOM, width: "11%" }}>Ngày phân công Công chức nghiên cứu</th>
                  <th style={{ ...TH_CUSTOM, width: "13%" }}>Công chức nghiên cứu</th>
            ...
            <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div>
                <label style={{ fontSize: 12, fontWeight: 600, color: TEXT, display: "block", marginBottom: 6 }}>
                  Chọn Công chức nghiên cứu giải quyết (*)
                </label>
                <select
                  value={assignTTV}
          ...
          <div style={{ background: "#fff", borderRadius: 10, width: "100%", maxWidth: 640, boxShadow: "0 20px 50px rgba(0,0,0,0.25)", overflow: "hidden", fontFamily: F }}>
            ...
            <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 12, fontSize: 12 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "140px 1fr", gap: 8, padding: "6px 0" }}>
                <span style={{ color: MUTED, fontWeight: 600 }}>Công chức nghiên cứu:</span>
