  ...
  return (
    <div className="bg-[#fff7ed] content-stretch flex items-center justify-center px-[9px] py-[2px] relative rounded-[9999px] shrink-0 w-[110px]" data-name="Background+Border">
      ...
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ea580c] text-[10px] whitespace-nowrap">
        <p className="leading-[16px]">Chưa có vụ án</p>
      </div>
    </div>
  );
}
...
function TlVAnChaCoVAn() {
  return (
    <div className="col-1 content-stretch flex h-[1038px] items-start ml-0 mt-0 relative row-1 w-[1380px]" style={{ backgroundImage: "linear-gradient(90deg, rgb(243, 244, 246) 0%, rgb(243, 244, 246) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }} data-name="TL vụ án- chưa có vụ án">
      <Main />
    </div>
  );
}
